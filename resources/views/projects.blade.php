...
@section('content')
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('{{ asset('img/content/20240210_105102.jpg') }}'); background-size: cover; background-position: center;">
