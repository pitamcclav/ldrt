      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <p data-aos="fade-up"> LRFDT is a community-oriented Organization with the intention to
 empower and make the Rural community productive and be self-sustaining.  Our Mission is to empower Communities through Sustainable Development Iniatives</p>
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active" style="background-image: url({{ asset('img/content/IMG-20230315-WA0013.jpg') }})"></div>
      <div class="carousel-item" style="background-image: url({{ asset('img/content/IMG-20230316-WA0003.jpg') }})"></div>
      <div class="carousel-item" style="background-image: url({{ asset('img/content/20231128_162452.jpg') }})"></div>
      <div class="carousel-item" style="background-image: url({{ asset('img/content/20181206_145906.jpg') }})"></div>
      <div class="carousel-item" style="background-image: url({{ asset('img/content/20231127_165629.jpg') }})"></div>
