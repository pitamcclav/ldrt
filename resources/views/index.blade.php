...
<!-- ======= Hero Section ======= -->
  <section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item" style="background-image: url({{ asset('img/content/20240111_145554.jpg') }})"></div>
      <div class="carousel-item" style="background-image: url({{ asset('img/content/alt-services.jpg') }})"></div>
      <div class="carousel-item" style="background-image: url({{ asset('img/content/constructions-1.jpg') }})"></div>
      <div class="carousel-item" style="background-image: url({{ asset('img/content/20240210_150109.jpg') }})"></div>
